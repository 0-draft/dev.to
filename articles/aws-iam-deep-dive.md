...
![AuthN and AuthZ overview](./assets/aws-iam-deep-dive/diagrams/01-authn-authz-overview.svg)
...
![AssumeRole sequence](./assets/aws-iam-deep-dive/diagrams/02-assume-role-sequence.svg)
...
![SigV4 signing sequence](./assets/aws-iam-deep-dive/diagrams/03-sigv4-sequence.svg)

### What the 4 Steps Actually Do

![SigV4 four steps](./assets/aws-iam-deep-dive/diagrams/04-sigv4-four-steps.svg)
...
![Policy evaluation flow](./assets/aws-iam-deep-dive/diagrams/05-policy-evaluation.svg)
...
![IAM Identity Center topology](./assets/aws-iam-deep-dive/diagrams/06-identity-center.svg)
